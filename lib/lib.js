...
exports.delete = function (filename, data) {
    ...
    if(result.affectedRows){
        return {message:"Data have been sucessfully deleted from databasel", rows:result.affectedRows};
    }else{
        return new Error("Unreacheable data detected. Please check id value and try again");
    }
