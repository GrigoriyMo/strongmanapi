...
function collectSportsman(data) {
    ...
    for (var z = 0; z < data.length; z++) {
        ...
        if (data[z].cityTitle === 'Москва') {
            for (var i = 0; i < part_titles.length; i++) {
                if (part_titles[i] === data[z].cityTitle) {
                    result.sportsman[i].atlets.push(data[z])
                }
            }
        }
        ...
        if (data[z].cityTitle === 'Северо - запад') {
            for (var i = 0; i < part_titles.length; i++) {
                if (part_titles[i] === data[z].cityTitle) {
                    result.sportsman[i].atlets.push(data[z])
               }
        ...
        if (data[z].cityTitle === 'Центр') {
            for (var i = 0; i < part_titles.length; i++) {
                if (part_titles[i] === data[z].cityTitle) {
                    part_titles[i].atlets.push(data[z])
                }
            }
        }

        if (data[z].cityTitle === 'Юг') {
            for (var i = 0; i < part_titles.length; i++) {
                if (part_titles[i] === data[z].cityTitle) {
                    part_titles[i].atlets.push(data[z])
                }
